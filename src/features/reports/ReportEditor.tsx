/**
 * LV-14 — Editor por blocos de um documento pericial (mock).
 * - Navegação lateral por seção.
 * - Cada bloco: título, conteúdo, indicadores (origem/manual/revisão) e fontes.
 * - Trocar modelo altera SOMENTE a estrutura inicial (as seções são recriadas).
 */
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                <Select
                  ...
                  onValueChange={(v) =>
                    setSectionStatus(doc.id, activeSection.id, v as ReportSectionStatus)
                  }
                >
